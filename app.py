...
modeL_DT = open('models/model_DT.pkl', 'rb')
modeL_GNB = open('models/model_GNB.pkl', 'rb')
modeL_KNN = open('models/model_KNN.pkl', 'rb')
modeL_LR = open('models/model_LR.pkl', 'rb')
modeL_RF = open('models/model_RF.pkl', 'rb')
modeL_SVM = open('models/model_SVM.pkl', 'rb')
...
def predict():
    ...
    return render_template('index.html', hasil_pred=output)
